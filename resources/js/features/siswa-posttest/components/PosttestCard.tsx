...
import type { PosttestCardItem } from "../types";
...
function ActionArea({ item }: { item: PosttestCardItem }) {
    ...
    if (availability === "in_progress") {
        return (
            <TestStartDialog
                item={{ ...item, availability_status: "in_progress" }}
                mode="resume"
    ...
    if (availability === "available") {
        return (
            <TestStartDialog
                ...
                mode="start"
                trigger={<Button>Mulai posttest</Button>}
            />
        );
    }

    if (availability === "locked_pretest") {
        return (
            <Button disabled variant="outline">
                Selesaikan pretest dulu
            </Button>
        );
    }
...
export default function PosttestCard({ item }: { item: PosttestCardItem }) {
    const availability = item.availability_status;
